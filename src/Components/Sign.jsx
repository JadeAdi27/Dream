...
const Sign = () => {
    ...
    <div className="bg-blue-400 p-10 h-[500px] w-[500px] mr-[5px] rounded-[20px] shadow-lg">
      ...
      <div className="bg-pink-300 p-10 h-[500px] w-[500px] rounded-[20px] shadow-lg">
        <h1 className="text-white text-4xl font-bold">Login. </h1>
           <div className="mt-8">
            ...
            <input className="shadow appearance-none border rounded-[13px] w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username" />
            <label className="block mt-4 text-white text-sm font-bold mb-2" htmlFor = "Password">Password</label>
            <input className="shadow appearance-none border rounded-[13px] w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id ="password" type="password" placeholder="password"/>
           </div>
